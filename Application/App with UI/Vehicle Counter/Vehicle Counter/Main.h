...
#pragma endregion
	...
	private: System::Void button3_Click(System::Object^  sender, System::EventArgs^  e) {
				...
				else
				{
					...
					if(stop && MessageBox::Show("Do you want to Save results to Excel file?","Message",MessageBoxButtons::YesNo,
					 MessageBoxIcon::Question)==System::Windows::Forms::DialogResult::Yes)		// save results if not testing
					{
						impgs[Video_No]->imgpp->saveResults(starth, startm, starts);stop = false;
	...
	private: System::Void button8_Click(System::Object^  sender, System::EventArgs^  e) {
				...
				for (int word=0; word<paths->Length; word+=2){
					MyClass^ temp=gcnew MyClass;
